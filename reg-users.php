...
<head>
    ...
    <title>Car Rental Portal | Registered Users</title>
	<style>
                            ...
                            <table id="usersTable" class="data-table">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td data-label="Name"><?php echo htmlentities($result->FullName); ?></td>
                                        <td data-label="Email"><?php echo htmlentities($result->EmailId); ?></td>
                                        <td data-label="Contact"><?php echo htmlentities($result->ContactNo); ?></td>
                                        <td data-label="DOB"><?php echo htmlentities($result->dob); ?></td>
                                        <td data-label="Address"><?php echo htmlentities($result->Address); ?></td>
                                        <td data-label="City"><?php echo htmlentities($result->City); ?></td>
                                        <td data-label="Country"><?php echo htmlentities($result->Country); ?></td>
                                        <td data-label="Reg Date"><?php echo htmlentities($result->RegDate); ?></td>
                                    </tr>
                                <?php 
                                    $cnt++;
                                    }
                                ...
                                ?>
                                    <tr>
                                        <td colspan="9" class="no-records">No registered users found</td>
                                    </tr>
                                <?php } ?>
                                </tbody>
                            </table>
