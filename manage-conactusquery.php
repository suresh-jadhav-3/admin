...
?>
	...
	<head>
		...
		<title>Car Rental Portal | Manage Contact Queries</title>
			...
			<div class="content-wrapper">
				<div class="container">
					<div class="page-header">
						<h1 class="page-title">Manage Contact Queries</h1>
					</div>

					<div class="card">
						<div class="card-header">
							<h2 class="card-title">User Queries</h2>
						...
						<div class="card-body">
							<div class="table-responsive">
								<table id="queriesTable" class="data-table">
									<thead>
										<tr>
											<th>#</th>
											<th>Name</th>
									...
									<tbody>
										...
										?>
												<tr>
													...
													<td data-label="Contact No"><?php echo htmlentities($result->ContactNumber); ?></td>
													<td data-label="Message"><?php echo htmlentities($result->Message); ?></td>
													<td data-label="Posting date"><?php echo htmlentities($result->PostingDate); ?></td>
											...
											?>
											<tr>
												<td colspan="7" class="no-records">No queries found</td>
											</tr>
										<?php } ?>
									</tbody>
								</table>
