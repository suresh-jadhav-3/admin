...
?>
	...
	<head>
		...
		<title>Car Rental Portal | Manage Testimonials</title>
		<style>
				...
				<div class="container">
					...
					<div class="card">
						<div class="card-header">
							<h2 class="card-title">User Testimonials</h2>
								...
								<table id="bookingsTable" class="data-table">
									...
									<tbody>
										...
										?>
											...
											?>
											<tr>
												<td colspan="6" class="no-records">No testimonials found</td>
											</tr>
										<?php } ?>
									</tbody>
								</table>
